#!/usr/bin/env python
"""Render the transformer layout with port 1-5 positions labeled.
...
201-205 -- the source_layernum values used in the palace_transformer_imn_*.py
model scripts): 201/202 = primary +/-, 203 = primary center tap,
204/205 = secondary +/-.
"""
import os
import sys
...
OUT_FILE = os.path.join(HERE, "plots", "transformer_layout_labeled.png")

PORT_LAYERS = {1: 201, 2: 202, 3: 203, 4: 204, 5: 205}
PORT_NAMES = {1: "Port 1 (pri+)", 2: "Port 2 (pri-)", 3: "Port 3 (pri CT)",
              4: "Port 4 (sec+)", 5: "Port 5 (sec-)"}
...
def main():
    ...
    for port_num, (cx, cy) in centroids.items():
        ...
        ax.annotate(
            PORT_NAMES[port_num],
            xy=(cx, cy),
            xytext=(cx + dx * span * 0.10, cy + dy * span * 0.10),
