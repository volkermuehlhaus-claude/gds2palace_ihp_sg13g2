...
# Mesh convergence study variant: uniform mesh, 3 um, order 1 (order comparison)
# Generated as part of the ind_frame mesh convergence study
...
settings['order'] = 1  # order of FEM basis functions
