...
|---|---:|---:|---:|---:|
| 5 µm | 161,484 | 23,333 | 47.5 s | 2.51 GB |
| 3 µm | 284,030 | 41,082 | 1m 29s | 3.77 GB |
| 2 µm | 429,096 | 62,016 | 2m 20s | 5.37 GB |
| 1 µm | 881,044 | 125,218 | 5m 5s | 9.47 GB |
...
|---|---:|---:|---:|---:|---:|
| 1 | 161,484 | 23,333 | n/a | 48.0 s | 2.62 GB |
| 2 | 294,110 | 49,429 | 0.0146 | 2m 42s | 4.18 GB |
| **Final** | **863,146** | **151,006** | **0.0102** | **9m 54s** | **11.16 GB** |

Iteration 1 matches the 5 µm uniform mesh run exactly, as expected. Max|ΔS| keeps decreasing through the final iteration here — unlike a run given a larger iteration budget, this 2-iteration run doesn't show a clear "diminishing returns" plateau; the final iteration still delivers a meaningful accuracy gain (Max|ΔS| more than halves, from 0.0146 to 0.0102).
...
|---|---:|---:|---:|---:|
| 5→3 µm | 0.0158 | 0.0497 | 0.0212 | 0.0118 |
| 3→2 µm | 0.0058 | 0.0235 | 0.0106 | 0.0030 |
| 2→1 µm | 0.0056 | 0.0198 | 0.0122 | 0.0005 |
| 1µm→AMR final | 0.0024 | 0.0025 | 0.0009 | 0.0000 |

#### S21

| Comparison | Max\|ΔS\| (linear) | \|ΔS\|@1GHz (dB) | \|ΔS\|@25GHz (dB) | \|ΔS\|@50GHz (dB) |
|---|---:|---:|---:|---:|
| 5→3 µm | 0.0065 | 0.0001 | 0.0124 | 0.1343 |
| 3→2 µm | 0.0025 | 0.0000 | 0.0072 | 0.0432 |
| 2→1 µm | 0.0019 | 0.0001 | 0.0070 | 0.0341 |
| 1µm→AMR final | 0.0007 | 0.0001 | 0.0018 | 0.0022 |

#### S22

| Comparison | Max\|ΔS\| (linear) | \|ΔS\|@1GHz (dB) | \|ΔS\|@25GHz (dB) | \|ΔS\|@50GHz (dB) |
|---|---:|---:|---:|---:|
| 5→3 µm | 0.0080 | 0.0495 | 0.0216 | 0.0115 |
| 3→2 µm | 0.0051 | 0.0237 | 0.0109 | 0.0028 |
| 2→1 µm | 0.0035 | 0.0204 | 0.0125 | 0.0005 |
| 1µm→AMR final | 0.0010 | 0.0021 | 0.0009 | 0.0000 |
...
|---|---:|---:|---:|---:|
| 5 µm | 0.0271 | 0.0930 | 0.0440 | 0.0153 |
| 3 µm | 0.0113 | 0.0433 | 0.0228 | 0.0036 |
| 2 µm | 0.0056 | 0.0198 | 0.0122 | 0.0005 |
| AMR final | 0.0024 | 0.0025 | 0.0009 | 0.0000 |

#### S21

| Mesh | Max\|ΔS\| vs. 1 µm (linear) | \|ΔS\|@1GHz (dB) | \|ΔS\|@25GHz (dB) | \|ΔS\|@50GHz (dB) |
|---|---:|---:|---:|---:|
| 5 µm | 0.0108 | 0.0002 | 0.0266 | 0.2116 |
| 3 µm | 0.0044 | 0.0001 | 0.0142 | 0.0773 |
| 2 µm | 0.0019 | 0.0001 | 0.0070 | 0.0341 |
| AMR final | 0.0007 | 0.0001 | 0.0018 | 0.0022 |

#### S22

| Mesh | Max\|ΔS\| vs. 1 µm (linear) | \|ΔS\|@1GHz (dB) | \|ΔS\|@25GHz (dB) | \|ΔS\|@50GHz (dB) |
|---|---:|---:|---:|---:|
| 5 µm | 0.0165 | 0.0936 | 0.0450 | 0.0149 |
| 3 µm | 0.0086 | 0.0441 | 0.0234 | 0.0034 |
| 2 µm | 0.0035 | 0.0204 | 0.0125 | 0.0005 |
| AMR final | 0.0010 | 0.0021 | 0.0009 | 0.0000 |
