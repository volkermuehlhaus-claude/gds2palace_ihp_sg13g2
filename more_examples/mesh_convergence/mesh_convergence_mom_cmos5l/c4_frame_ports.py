...
#
# Mesh convergence study template (base, unmodified mesh/order) for the
# c4_frame_ports MOM capacitor test structure, IHP SG13CMOS5L technology
# (a separate, newer IHP Open PDK offering alongside SG13G2 - 5-metal BEOL).
# Fixed single frequency (1 GHz, no sweep) - see AGENTS.md in the parent
# mesh_convergence/ folder for the overall study methodology. Variants
# (mesh200nm/100nm/50nm x order 2/3) are full copies of this file that only
# change settings['refined_cellsize']/['order'] plus a header comment.
