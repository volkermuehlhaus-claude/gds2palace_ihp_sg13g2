...
#
# Mesh convergence study variant: uniform mesh, 0.2 um, order 2, 0-50 GHz
# frequency sweep (documentation only - shows C12 vs. frequency at the
# largest/coarsest mesh size; the actual mesh/order convergence study uses
# the fixed 1 GHz point in the other c4_frame_ports_mesh*.py variants).
# c4_frame_ports MOM capacitor test structure, IHP SG13CMOS5L technology.
# See AGENTS.md in the parent mesh_convergence/ folder for the overall
# study methodology.
